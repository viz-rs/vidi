...
use crate::{future::FutureExt, Responder, Router};
...
pub fn serve<L>(
    listener: L,
    router: Router,
) -> Server<L, TokioExecutor, fn(TokioExecutor) -> Builder<TokioExecutor>> {
    Server::<L, TokioExecutor, fn(TokioExecutor) -> Builder<TokioExecutor>>::new(
        TokioExecutor::new(),
        listener,
        router,
        Builder::new,
