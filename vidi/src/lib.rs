...
//! # Handler
//!
//! A simple pattern `async fn(Request) -> Result<Response>` is used to handle requests in Vidi.
//!
//! ## Simple handlers
//!
//! ```
//! # use vidi::{IntoResponse, Request, Response, ResponseExt, Result};
...
//! # use vidi::{async_trait, Handler, IntoResponse, Request, RequestExt, Response, Result};
//! #[derive(Clone)]
//! struct MyHandler {
...
//!
//! ```
//! # use vidi::{get, types::Params, IntoResponse, IntoHandler, Result, Router};
...
//!
//! Vidi allows more flexibility in organizing your code.
//!
//! ```
//! # use vidi::{
...
//!
//! ```ignore
//! # use vidi::{handler, types::Params, IntoHandler, IntoResponse, Result, Router};
//!
//! #[handler]
...
//! # Middleware
//!
//! Vidi's middleware and handlers share a common [`Handler`] trait,
...
//! # use vidi::{FromRequest, Request, RequestExt, Result};
//! struct Counter(u16);
//!
...
//! # Routing
//!
//! The Vidi router recognizes URLs and dispatches them to a handler.
//!
//! ## Simple routes
//!
//! ```
//! # use vidi::{get, Request, Route, Router, Response, Result, IntoResponse};
//! #
//! async fn index(_: Request) -> Result<Response> {
//!     Ok(().into_response())
//! }
...
//!
//! ```
//! # use vidi::{get, Request, Resources, Response, ResponseExt, Result};
//! #
//! // GET `/search`
...
//!
//! ```ignore
//! # use vidi::{any, IntoResponse, Request, Result, Router, StatusCode};
//! async fn not_found(_: Request) -> Result<impl IntoResponse> {
